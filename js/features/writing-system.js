(() => {
  ...
  function ensureEditor() {
    ...
    node.innerHTML = `<section role="dialog" aria-modal="true" aria-label="Writing editor">
      ...
      <footer><button type="button" data-write-close>Cancel</button><button type="button" data-write-save="draft">Save draft</button><button type="button" class="primary" data-write-save="publish">Save published</button></footer>
    </section>`;
  ...
  function closeEditor() {
    document.getElementById("hsWritingEditor")?.classList.remove("open");
    editor = null;
  }
